...
def write_simplified_mcqs(
    ...
    """Read a detailed MCQ JSONL and write a simplified version.

    Replaces the full options list with ``option_a`` … ``option_d`` plus
    ``correct_answer``.
    ...
    if output_path is not None:
        ...
        out_path = detailed_path.parent / "simplified" / detailed_path.name
