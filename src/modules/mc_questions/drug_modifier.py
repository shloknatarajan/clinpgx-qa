...
Usage:
    python -m src.modules.mc_questions.drug_modifier
    python -m src.modules.mc_questions.drug_modifier --seed 42 --output data/mcq_options/drug_mcq_options.jsonl
"""
...
def generate_all_drug_mcqs(
    ...
    logger.info(f"Generated {total} drug MCQ entries")
    if notes_counter:
