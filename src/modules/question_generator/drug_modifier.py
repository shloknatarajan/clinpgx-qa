...
Usage:
    python -m src.modules.question_generator.drug_modifier
    python -m src.modules.question_generator.drug_modifier --seed 42 --output data/mcq_options/drug_mcq_options.jsonl
"""
